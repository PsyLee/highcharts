...
public class ScattersSelection extends Application
{

    public ScattersSelection()
    {
        url = getResource("scattersselection.html");
    }
